...
<p class="mt-3">
    Dado un número entero n, n ≥ 0, se debe mostrar el código y el nombre de todos los ingredientes
    cuyo proveedor tiene años en el mercado mayor a n.
</p>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST'):
    ...
    $query = "SELECT ingrediente.codigo, ingrediente.nombre FROM ingrediente JOIN proveedor ON ingrediente.nit_proveedor = proveedor.nit WHERE proveedor.anios_en_mercado > $numero";
