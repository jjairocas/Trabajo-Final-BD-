...
<div class="container mt-5">
    ...
    <h1>Trabajo final BD1 - (Pizzería Mammamía)</h1>
    ...
    <div class="integrantes">
        <h2>Integrantes</h2>
        <ul>
            <li>Juan David Henao Marín</li>
            <li>Juan Diego Marín Restrepo</li>
            <li>Jhon Jairo Castaño Ruíz</li>
        </ul>
    </div>
    ...
    <div class="enlaces">
        <h2>Enlaces</h2>
        <ul>
            <li><a href="proveedor/proveedor.php">Entidad análoga a CASILLERO (PROVEEDOR)</a></li>
            <li><a href="ingrediente/ingrediente.php">Entidad análoga a CLIENTE (INGREDIENTE)</a></li>
